...
import { BottomNavigation, BottomNavigationAction, List, ListItem, ListItemAvatar, Avatar, ListItemText, Typography, Divider, TextField } from '@material-ui/core';
import { Home as HomeIcon, Person as PersonIcon, Search as SearchIcon } from '@material-ui/icons';
    ...
    render(): React.ReactNode {
        ...
        switch (this.state.page) {
            case "home":
                content = (
                    <>
                        <div style={{ width: "100%", height: "100px", background: "#f1f1f1", display: "flex", justifyContent: "center", alignItems: "center" }}>
        ...
        return (
            <>
                ...
                >
                    <BottomNavigationAction label="Home" value="home" icon={<HomeIcon />} style={{ maxWidth: "none" }} />
                    <BottomNavigationAction label="Profile" value="profile" icon={<PersonIcon />} style={{ maxWidth: "none" }} />
                </BottomNavigation>
            </>
        )
    }
