...
export default class VectorEmbeddedPage extends EmbeddedPage {
    ...
    translate(s) {
        ...
        s = s.replace(
            /\[infogile\]/,
            '<a href="#" target="_blank" rel="noreferrer noopener"><img width="92" height="32" alt="[infogile]" style="padding-left: 1px;vertical-align: middle" src="welcome/images/logo.svg"/></a>'
        );
        return s;
    }
}
