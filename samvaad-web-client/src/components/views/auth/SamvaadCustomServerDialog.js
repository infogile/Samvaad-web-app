 ...
 * with "Riot".
 */
const SamvaadCustomServerDialog = ({ onFinished }) => {
    return (
        <div className="mx_ErrorDialog">
            <div className="mx_Dialog_title">{_t("Custom Server Options")}</div>
...
SamvaadCustomServerDialog.replaces = "CustomServerDialog";

export default SamvaadCustomServerDialog;
