...
export const TYPES = {
    FREE: {
        ...
        label: () => _t("Free"),
        logo: () => (
            <img src="https://material-ui.com/static/in-house/sketch.png" />
        ),
        description: () =>
    ...
    PREMIUM: {
        ...
        logo: () => (
            <img
                src="https://material-ui.com/static/in-house/sketch.png"
                height={16}
            />
        ),
        description: () =>
...
export default class ServerTypeSelector extends React.PureComponent {
    ...
    render() {
        ...
        return <div className="mx_ServerTypeSelector">{serverTypes}</div>;
    }
}
